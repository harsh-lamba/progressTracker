(function(){
	...
	function progressTrackerConfig($stateProvider, $urlRouterProvider){
		...
		$stateProvider
			.state('vacature', {
				url: '/vacature',
				templateUrl : 'template/vacature/vacature.html'
			})
			.state('vacature.label', {
				url: '/label',
				templateUrl : 'template/vacature/vacatureLabels.html'
			})
			.state('vacature.keywordPlanner', {
				url: '/keywordPlanner',
				templateUrl : 'template/vacature/vacatureKeywordPlanner.html'
			})
			...
			.state('instroom', {
				url: '/instroom',
				templateUrl : 'template/instroomManagement/instroomManagement.html'
			})
			...
			.state('concepten', {
				url: '/concepten',
				templateUrl : 'template/concepten/concepten.html'
			})
			...
			.state('publicates', {
				url: '/publicates',
				templateUrl : 'template/publicaties/publicaties.html'
			})
